"""
Enhanced Competition Controller for HCMC AI Challenge 2025
...
class EnhancedCompetitionController:
    """Enhanced controller with advanced task routing and optimization"""
    ...
    def __init__(
        ...
        self.agent = EnhancedCompetitionAgent(
            llm=llm,
    ...
    async def process_vcmr_automatic(
        ...
        try:
            ...
            response = await self.agent.enhanced_vcmr_automatic(request)
    ...
    async def process_video_qa(
        ...
        """Process Video QA task with enhanced context handling"""
        ...
        try:
            ...
            # Process with enhanced agent
            response = await self.agent.enhanced_video_qa(request)
    ...
    async def process_kis_textual(
        ...
        try:
            ...
            # Process with enhanced agent
            response = await self.agent.enhanced_kis_textual(request)
    ...
    async def process_kis_visual(
        ...
        try:
            ...
            # Process with enhanced agent
            response = await self.agent.enhanced_kis_visual(request)
    ...
    async def process_kis_progressive(
        ...
        try:
            ...
            # Process with enhanced agent
            response = await self.agent.enhanced_kis_progressive(
    ...
    async def process_vcmr_interactive(
        ...
        try:
            ...
            # Process with enhanced interactive logic
    ...
    async def _process_interactive_vcmr(
        ...
        auto_response = await self.agent.enhanced_vcmr_automatic(auto_request)
